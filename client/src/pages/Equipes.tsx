  ...
  const teams = [
    {
      ...
      level: "Initiation",
      players: "32 joueurs",
      coach: "Aurélie Derbre",
      schedule: "Vendredi 17h15-18h30, Samedi 13h-14h",
      description: "Découverte du roller hockey dans une ambiance ludique et conviviale. Apprentissage des bases : patinage, maniement de la crosse et esprit d'équipe. Pour les plus jeunes débutants et adultes débutants le samedi.",
    },
    {
      id: "2",
      category: "U7-U11",
      ...
      players: "34 joueurs",
      coach: "Aurélie Derbre",
      schedule: "Mercredi 16h30-17h45 (Débutants U7-U11), 17h45-19h (U11-U13) • Samedi 13h30-14h30 (Débutants), 14h30-15h30 (U11-U13)",
      description: "Perfectionnement technique et tactique. Introduction aux compétitions départementales. Développement de l'autonomie et de la cohésion d'équipe. Créneaux séparés pour débutants et confirmés.",
    },
    {
      id: "3",
      category: "U13",
      ...
      players: "28 joueurs",
      coach: "Aurélie Derbre",
      schedule: "Mercredi 17h45-19h, Samedi 14h30-15h30",
    ...
    },
    {
      ...
      level: "Régional",
      players: "27 joueurs",
      coach: "Julien Coach Roller",
      schedule: "Mercredi 19h-20h30, Samedi 15h30-16h45",
      description: "Perfectionnement des stratégies de jeu et renforcement de la condition physique. Compétition régionale avec objectif de progression constante. Participation à des tournois interrégionaux.",
    },
    {
      id: "5",
      category: "U17",
    ...
    },
    {
      ...
      level: "Interrégional",
      players: "14 joueurs",
      coach: "Équipe encadrante",
      schedule: "Mardi 19h30-20h45, Vendredi 19h-20h30",
    ...
    },
    {
      ...
      category: "Adultes",
      ageRange: "20-45 ans",
      level: "National (N1 & N3)",
      players: "À confirmer",
      coach: "Équipe encadrante",
      schedule: "Horaires à confirmer - Voir École de patinage pour débutants (Samedi 13h-14h)",
      description: "Équipe senior évoluant en championnat National. Deux équipes : N1 (Nationale 1) et N3 (Nationale 3). Ambiance conviviale et compétitive, ouverte aux joueurs de tous niveaux souhaitant pratiquer le roller hockey en loisir ou en compétition.",
    },
  ];
