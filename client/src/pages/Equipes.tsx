...
export default function Equipes() {
  const teams = [
    {
      id: "1",
      category: "Mini-Jokers",
      ageRange: "6-8 ans",
      level: "Initiation",
      players: "12 joueurs",
      coach: "Sophie Martin",
      schedule: "Mercredi 14h-15h30, Samedi 10h-11h30",
      description: "Découverte du roller hockey dans une ambiance ludique et conviviale. Apprentissage des bases : patinage, maniement de la crosse et esprit d'équipe.",
    },
    {
      id: "2",
      category: "Poussins",
    ...
    },
    {
      ...
      description: "Équipe évoluant en Nationale 1, Groupe 2. Actuellement 3ème au classement avec 19 points. Ambition : montée en Elite.",
    },
  ];
      ...
      <section className="bg-card py-12 lg:py-16 border-b">
        <div className="max-w-7xl mx-auto px-4 md:px-8 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            De 6 à 25 ans, découvrez toutes nos équipes et rejoignez la famille des Jokers
          </p>
        </div>
      </section>
